...
$rekening = $this->db->get('rekening');
 ?>
    ...
    <script>
        ...
        $("#paymentSelectKurir").change(function(){
            $("#paymentSelectService").select2({
                placeholder: 'Loading..'
            })
            const id = $(this).val();
            ...
            if(destination === ""){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data.list !== ""){
                            $("#textNotFoundServicePayment").hide();
                            $("#paymentSelectService").html(data.list);
                            paymentSelectService();
                            $("#paymentSelectService").select2({
                                placeholder: 'Pilih Service'
                            })
                        }else{
                            $("#textNotFoundServicePayment").show();
                            $("#textNotFoundServicePayment").text("Metode Pengiriman ini tidak ada");
                            $("#paymentSelectService").select2({
                                placeholder: 'Metode Pengiriman ini tidak ada'
                            })
                        }
                    }
                });
        ...
        $("#paymentSelectService").change(paymentSelectService);

        function paymentSelectService(){
            let id = $("#paymentSelectService").val();
            id = id.split('-');
            id = id[0];
            if(id === ""){
                id = 0;
