    ...
    <div class="core">
        ...
        <div class="send">
            ...
            <div class="form-group mt-3">
                ...
                <small class="text-danger" id="paymentTextErrorAboveSelectKurir" style="display: none;">Pilih alamat terlebih dahulu</small>
            </div>
            <div class="form-group">
                <select name="paymentSelectService" id="paymentSelectService" class="form-control" required>
                    <option></option>
                </select>
                <small class="text-danger" id="textNotFoundServicePayment"></small>
            </div>
        </div>
        <?php }else{ ?>
